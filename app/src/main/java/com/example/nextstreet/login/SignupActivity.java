...
public class SignupActivity extends AppCompatActivity {
  ...
  private class SignupOnClickListener implements View.OnClickListener {
    ...
    public void onClick(View view) {
      ...
      if (firstName.isEmpty()
          ...
          || password.isEmpty()
          || password2.isEmpty()) {
        Toast.makeText(SignupActivity.this, R.string.toast_required_fields_err, Toast.LENGTH_SHORT)
            .show();
      } else if (!password2.equals(password)) {
        Toast.makeText(SignupActivity.this, R.string.toast_match_password, Toast.LENGTH_SHORT)
            .show();
      } else {
  ...
  private void signupUser(
      final String username, String password, String firstName, String lastName, String email) {
    ...
    user.signUpInBackground(new SignupCallback(TAG, binding.getRoot(), this, username, password));
  }
}
