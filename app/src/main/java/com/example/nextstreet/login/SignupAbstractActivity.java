...
public abstract class SignupAbstractActivity extends AppCompatActivity {
    ...
    private void signupUser(
            final String username, String password, String firstName,
            String lastName, String email, boolean isDriver) {
    ...
    private class SignupOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (firstName.isEmpty()
                    ...
                    || password.isEmpty()
                    || password2.isEmpty()) {
                Toast.makeText(SignupAbstractActivity.this, R.string.toast_required_fields_err, Toast.LENGTH_SHORT)
                        .show();
            } else if (!password2.equals(password)) {
                Toast.makeText(SignupAbstractActivity.this, R.string.toast_match_password, Toast.LENGTH_SHORT)
                        .show();
            } else {
